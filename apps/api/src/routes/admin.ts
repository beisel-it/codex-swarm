    ...
    return app.observability.withTrace(
      ...
      async () => {
        ...
        await app.observability.recordTimelineEvent(
          timelineEvent(controlPlaneEvents.adminGovernanceReportGenerated, {
  ...
  app.post("/admin/retention/reconcile", async (request) => {
    return app.observability.withTrace(
      ...
      async () => {
        ...
        await app.observability.recordTimelineEvent(
          timelineEvent(controlPlaneEvents.adminRetentionReconciled, {
