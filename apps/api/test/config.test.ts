...
describe("getConfig", () => {
  ...
  it("applies documented defaults", () => {
    ...
    const config = getConfig({
      ...
      AUTH_SERVICE_TOKEN: undefined,
      AUTH_SERVICE_PRINCIPAL: undefined,
      AUTH_SERVICE_ACTOR_ID: undefined,
      AUTH_SERVICE_WORKSPACE_ID: undefined,
      AUTH_SERVICE_WORKSPACE_NAME: undefined,
      AUTH_SERVICE_TEAM_ID: undefined,
      AUTH_SERVICE_TEAM_NAME: undefined,
      AUTH_SERVICE_POLICY_PROFILE: undefined,
    ...
    expect(config).toMatchObject({
      ...
      AUTH_SESSION_COOKIE_NAME: "codex_swarm_session",
      AUTH_SESSION_TTL_SECONDS: 604800,
      AUTH_SESSION_COOKIE_SAME_SITE: "lax",
      AUTH_SESSION_COOKIE_SECURE: false,
      AUTH_SERVICE_TOKEN: undefined,
      AUTH_SERVICE_PRINCIPAL: "control-plane-service",
      AUTH_SERVICE_ACTOR_ID: "control-plane-service",
      AUTH_SERVICE_WORKSPACE_ID: "default-workspace",
      AUTH_SERVICE_WORKSPACE_NAME: "Default Workspace",
      AUTH_SERVICE_TEAM_ID: "codex-swarm",
      AUTH_SERVICE_TEAM_NAME: "Codex Swarm",
      AUTH_SERVICE_POLICY_PROFILE: "standard",
      AUTH_ENABLE_LEGACY_DEV_BEARER: false,
      AUTH_PASSWORD_SCRYPT_N: 16384,
      AUTH_PASSWORD_SCRYPT_R: 8,
      AUTH_PASSWORD_SCRYPT_P: 1,
      AUTH_PASSWORD_SCRYPT_KEYLEN: 64,
  ...
  it("parses environment overrides", () => {
    const config = getConfig({
      ...
      AUTH_SERVICE_PRINCIPAL: "worker-daemon",
      AUTH_SERVICE_ACTOR_ID: "worker-daemon",
      AUTH_SERVICE_WORKSPACE_ID: "workspace-a",
      AUTH_SERVICE_WORKSPACE_NAME: "Workspace A",
      AUTH_SERVICE_TEAM_ID: "team-a",
      AUTH_SERVICE_TEAM_NAME: "Team A",
      AUTH_SERVICE_POLICY_PROFILE: "sensitive",
      AUTH_ENABLE_LEGACY_DEV_BEARER: false,
      AUTH_PASSWORD_SCRYPT_N: 16384,
      AUTH_PASSWORD_SCRYPT_R: 8,
      AUTH_PASSWORD_SCRYPT_P: 1,
