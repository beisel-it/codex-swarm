  ...
  tasks: [
    {
      ...
      runId: "run-alpha",
      title:
        "Translate clawteam board inspiration into Ink composition language",
      description:
        "Use codex-swarm-specific panels and operator density instead of a generic terminal dashboard.",
      role: "designer",
      status: "completed",
      priority: 5,
    ...
    },
    {
      ...
      description:
        "Ship live summary cards, kanban columns, and shell navigation in apps/tui.",
      role: "frontend",
      status: "in_progress",
      priority: 5,
    ...
    },
    {
      ...
      description:
        "Highlight degraded workers, draining nodes, and stale sessions from the TUI shell.",
      role: "developer",
      status: "blocked",
      priority: 4,
      ownerAgentId: "agent-frontend",
    ...
    },
    {
      ...
      description:
        "Confirm the handoff boundary, required artifacts, and failure rules before scenario dispatch.",
      role: "reviewer",
  ...
  approvals: [
    {
      ...
      requestedPayload: {
        summary:
          "Approve the M9 designer/developer playbook before the landing-page scenario is dispatched.",
      },
      resolutionPayload: {},
      resolver: null,
      resolvedAt: null,
