module.exports = {
  hero: {
    ...
    screenshot: {
      ...
      caption: "Run Board keeps active work, blockers, approvals, and diagnostics in one control frame."
    }
  },
  operatorLoop: {
  ...
  capabilities: {
    ...
    title: "The control plane is opinionated where delivery risk actually lives.",
    intro:
  ...
  finalCta: {
    ...
    title: "Inspect the repo. Read the operating docs. Start shaping governed delivery.",
    body:
