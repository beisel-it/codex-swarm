...
export const repositoryTrustLevels = [
  "trusted",
  "sandboxed",
  "restricted",
] as const;
export const pullRequestStatuses = [
  "draft",
  "open",
  "merged",
  "closed",
...
export const handoffExecutionStates = [
  "idle",
  "pending",
  "in_progress",
  "failed",
...
export const agentObservabilityModes = [
  "session",
  "transcript_visibility",
  "unavailable",
] as const;
export const agentObservabilityLineageSources = [
  "active_session",
  "session_rollover",
  "task_reassignment",
...
export const workerNodeStates = [
  "active",
  "draining",
  "drained",
  "offline",
] as const;
export const workerDispatchStates = [
  "queued",
  "claimed",
  "completed",
  "retrying",
...
export const externalEventReceiptStatuses = [
  "received",
  "rejected",
  "run_created",
  "failed",
...
export const projectTeamImportSchema = z
  .object({
    projectId: z.uuid(),
  ...
  .superRefine((value, ctx) => {
    ...
    if (
      value.blueprintId &&
      value.templateId &&
      value.blueprintId !== value.templateId
    ) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        path: ["templateId"],
...
export const projectTeamUpdateSchema = z
  .object({
...
export const repositoryUpdateSchema = z
  .object({
    name: z.string().min(1).optional(),
...
export const webhookTriggerConfigSchema =
  webhookTriggerConfigInputSchema.extend({
...
export const inboundExternalEventEnvelopeSchema = z.discriminatedUnion(
  "sourceType",
...
export const runHandoffConfigSchema = z
  .object({
  ...
  .superRefine((value, ctx) => {
    ...
    if (!value.autoPublishBranch && !value.autoCreatePullRequest) {
      ctx.addIssue({
        ...
        message:
          "auto handoff requires autoPublishBranch or autoCreatePullRequest",
      });
    }
...
export const repeatableRunDefinitionSchema =
  repeatableRunDefinitionCreateSchema.extend({
...
export const workerDispatchCompletionOutcomeSchema = z.discriminatedUnion(
  "kind",
  [
    z.object({
...
export const agentObservabilitySchema = z
  .object({
    ...
    visibleTranscriptSessionState: z
      .enum(workerSessionStates)
      .nullable()
      .default(null),
    visibleTranscriptUpdatedAt: z.date().nullable().default(null),
    lineageSource: z
      .enum(agentObservabilityLineageSources)
      .default("not_started"),
  })
  .superRefine((value, ctx) => {
    ...
    if (
      value.mode === "transcript_visibility" &&
      !value.visibleTranscriptSessionId
    ) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        path: ["visibleTranscriptSessionId"],
        message:
          "transcript_visibility mode requires visibleTranscriptSessionId",
      });
    }

    if (
      value.mode === "unavailable" &&
      (value.currentSessionId || value.visibleTranscriptSessionId)
    ) {
      ctx.addIssue({
        code: z.ZodIssueCode.custom,
        path: ["mode"],
...
export const workerNodeSchema = workerNodeRegisterSchema
  .extend({
    id: z.uuid(),
...
export const artifactDiffChangeTypes = [
  "added",
  "modified",
  "deleted",
  "renamed",
...
export const validationCreateSchema = z
  .object({
    runId: z.uuid(),
    taskId: z.uuid().optional(),
...
export const secretIntegrationBoundarySchema = z.object({
  ...
  allowedRepositoryTrustLevels: z
    .array(z.enum(repositoryTrustLevels))
    .default(["trusted"]),
...
export type ProjectTeamMemberCreateInput = z.infer<
  typeof projectTeamMemberCreateSchema
>;
...
export type RepeatableRunDefinitionCreateInput = z.infer<
  typeof repeatableRunDefinitionCreateSchema
>;
export type RepeatableRunDefinition = z.infer<
  typeof repeatableRunDefinitionSchema
>;
export type RepeatableRunTriggerCreateInput = z.infer<
  typeof repeatableRunTriggerCreateSchema
>;
...
export type WebhookTriggerConfigInput = z.infer<
  typeof webhookTriggerConfigInputSchema
>;
export type WebhookTriggerConfig = z.infer<typeof webhookTriggerConfigSchema>;
export type WebhookRequestMetadata = z.infer<
  typeof webhookRequestMetadataSchema
>;
export type InboundWebhookEventEnvelope = z.infer<
  typeof inboundWebhookEventEnvelopeSchema
>;
export type InboundExternalEventEnvelope = z.infer<
  typeof inboundExternalEventEnvelopeSchema
>;
export type RunExternalInputContext = z.infer<
  typeof runExternalInputContextSchema
>;
...
export type RunBudgetCheckpointInput = z.infer<
  typeof runBudgetCheckpointSchema
>;
export type AgentTeamBlueprintMember = z.infer<
  typeof agentTeamBlueprintMemberSchema
>;
...
export type ProjectRepositoryAssignment = z.infer<
  typeof projectRepositoryAssignmentSchema
>;
...
export type SessionTranscriptEntry = z.infer<
  typeof sessionTranscriptEntrySchema
>;
export type SessionTranscriptEntryCreateInput = z.infer<
  typeof sessionTranscriptEntryCreateSchema
>;
export type WorkerNode = z.infer<typeof workerNodeSchema>;
export type Approval = z.infer<typeof approvalSchema>;
export type Artifact = z.infer<typeof artifactSchema>;
export type ArtifactDiffFileSummary = z.infer<
  typeof artifactDiffFileSummarySchema
>;
...
export type WorkerNodeHeartbeatInput = z.infer<
  typeof workerNodeHeartbeatSchema
>;
export type WorkerNodeDrainUpdateInput = z.infer<
  typeof workerNodeDrainUpdateSchema
>;
...
export type ValidationHistoryEntry = z.infer<
  typeof validationHistoryEntrySchema
>;
...
export type RunPullRequestHandoffInput = z.infer<
  typeof runPullRequestHandoffSchema
>;
...
export type ControlPlaneEventEntityType =
  (typeof controlPlaneEventEntityTypes)[number];
export type ControlPlaneEvent = z.infer<typeof controlPlaneEventSchema>;
export type RetentionPolicy = z.infer<typeof retentionPolicySchema>;
export type RetentionWindowSummary = z.infer<
  typeof retentionWindowSummarySchema
>;
export type ControlPlaneMetrics = z.infer<typeof controlPlaneMetricsSchema>;
export type WorkerDispatchAssignment = z.infer<
  typeof workerDispatchAssignmentSchema
>;
export type WorkerDispatchCreateInput = z.infer<
  typeof workerDispatchCreateSchema
>;
export type WorkerDispatchListQuery = z.infer<
  typeof workerDispatchListQuerySchema
>;
export type WorkerDispatchCompleteInput = z.infer<
  typeof workerDispatchCompleteSchema
>;
export type WorkerDispatchCompletionOutcome = z.infer<
  typeof workerDispatchCompletionOutcomeSchema
>;
...
export type WorkerRuntimeDependencyCheck = z.infer<
  typeof workerRuntimeDependencyCheckSchema
>;
...
export type WorkerNodeReconcileInput = z.infer<
  typeof workerNodeReconcileSchema
>;
export type WorkerNodeReconcileReport = z.infer<
  typeof workerNodeReconcileReportSchema
>;
...
export type SecretIntegrationBoundary = z.infer<
  typeof secretIntegrationBoundarySchema
>;
export type GovernanceAdminReport = z.infer<typeof governanceAdminReportSchema>;
export type RetentionReconcileReport = z.infer<
  typeof retentionReconcileReportSchema
>;
